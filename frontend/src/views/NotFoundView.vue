...
const updatePageTitle = () => {
  document.title = 'Página não encontrada | PromoTech';
};
...
<template>
  <section class="flex flex-col w-full h-full max-w-[1240px] m-auto mt-[150px] mb-[50px] px-[20px] items-center text-center">
