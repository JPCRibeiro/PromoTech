...
const cepInput = ref('');
const cepErro = ref('')
const cepNumeroInput = ref('');
const complementoInput = ref('');
const cepData = ref({})
const selectedPayment = ref('');
const ccNumeroInput = ref('')
const ccNomeInput = ref('')
const ccCvvInput = ref('')
      ...
      <div class="flex-1">
        ...
        <div>
          ...
          <div class="flex flex-col pt-[16px]">
            <InputField :focusout="getCep" id="cep" v-model:title="cepInput" label="CEP" type="number" :error="cepErro" :isCheckoutPage="true"/>
            <InputField id="endereco" v-model:title="cepData.street" label="Endereço" type="text" :isCheckoutPage="true" :disabled="true"/>
            <InputField id="numero" v-model:title="cepNumeroInput" label="Número" type="text" :isCheckoutPage="true"/>
        ...
        <div>
          ...
          <div class="mb-[12px] rounded-[10px] border-[1px] border-[red] text-[red] w-fit py-[12px] px-[14px] flex items-center gap-[8px]">
            <font-awesome-icon icon="exclamation"/>
            <p class="font-[500]">Este website é apenas um projeto, não insira nenhum dado de pagamento real</p>
          </div>
            ...
            <div>
              ...
              <div :class="['overflow-hidden max-h-0 transition-[max-height] duration-200 ease-out', selectedPayment === 'cartao' ? 'max-h-[400px] border-[1px] border-[#777777] rounded-ss-[0px] rounded-se-[0px] rounded-[8px]' : 'max-h-0']">
                <div class="p-[16px_12px_16px]">
                  <InputField id="numeroCartao" v-model:title="ccNumeroInput" type="number" label="Número do cartão":isCheckoutPage="true"/>
                  <InputField id="nomeCartao" v-model:title="ccNomeInput" type="text" label="Nome no cartão" :isCheckoutPage="true"/>
                  <InputField id="cvv" v-model:title="ccCvvInput" type="number" label="CVV" :isCheckoutPage="true"/>
                </div>
              </div>
            </div>
          </div>
