        ...
        <div v-if="user" class="relative group">
          ...
          <div class="absolute top-0 right-0 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-200 ease-in-out group-hover:transform z-[50] min-w-[200px] transform">
            <div class="relative top-[24px] p-[12px] bg-white rounded-xl shadow-xl w-full">
              <div class="w-10 h-10 bg-white transform rotate-45 absolute top-0 right-[25%] translate-x-[25%] z-[0] translate-y-[50px] transition-transform group-hover:translate-y-[0] duration-300 ease-in-out rounded-sm"></div>
              <div class="relative z-[100] flex flex-col">
                <RouterLink to="/compras" class="block px-[16px] py-[8px] rounded-lg hover:bg-[#EFF4FF] transition duration-200 text-gray-800 font-semibold hover:text-[#4062e5] select-none">Minhas compras</RouterLink>
